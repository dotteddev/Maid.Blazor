			...
			.ForAttributeWithMetadataName(
				...
				transform: static (ctx, ct) =>
				{
					...
					var properties = (ctx.TargetNode as ClassDeclarationSyntax).Members
						...
						.Select(
							property => new AutoFillProperties.AutoFillPropertiesGenerator.PropertyInfo
							{
					...
					return new AutoFillProperties.AutoFillPropertiesGenerator.ClassInfo
					{
						Usings = [.. usings],
...
");
	...
	internal record ClassInfo
	{
		...
		public EquatableList<AutoFillProperties.AutoFillPropertiesGenerator.PropertyInfo> Properties { get; set; }
